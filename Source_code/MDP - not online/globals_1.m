...
% Written by Yu Xiang
% --------------------------------------------------------
function opt = globals_1()
opt.root = pwd;
opt.video = '~/Documents/Pre/data/SMSQ20short50.avi';


opt.det = '~/Documents/Pre/groundTruth/SMSQ20short.txt';
% path for MOT benchmark
%mot_paths = {'~/Documents/MATLAB/Pre/data/SMSQ20'};
...
addpath(fullfile('~/Documents/Pre/Source_code/MDP_Tracking-master/', '2DMOT15', 'devkit', 'utils'));
