...
% A simple way to stich together solution from successive temporal windows
% based on trajectory proximity during window overlap, cf. Fig 11, PAMI
% for w=1:wincnt
...
%     Xtmp
    ...
    [prox proxt proxcost]=getSplineProximity(mh,overlapSize,stTmp,opt);
