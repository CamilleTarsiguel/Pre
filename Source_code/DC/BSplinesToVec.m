function stateVec=BSplinesToVec(spl)
% Convert B-splines structs to a state vector
%
...
% preallocate space number of coefs * 2 (dim=2)
stateVec=zeros(sum([spl(:).number])*2,1);
