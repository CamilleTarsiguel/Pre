function energy=printEnergies( i, stateVec, splines,alldpoints, alldvpoints, opt, sceneInfo, labeling, vlabeling, oldEnergy)


global dcStartTime globiter

if opt.verbosity>=3
    [~, ~, energy] = Econ(stateVec, splines,alldpoints, alldvpoints, opt, sceneInfo, labeling, vlabeling, oldEnergy);
